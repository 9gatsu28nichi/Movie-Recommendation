...
def install_data():
    ...
    # Locate project root relative to this script (scripts/install_data.py -> root)
    ...
    try:
        ...
        print(f"🧪 Hydrating {target_filename} into project data folder...")
        ...
        print("🚀 You are now ready to launch CineMatch with 'streamlit run src/app.py'")
        print("------------------------------------------")
